...
public class CompteBancaire {
	 ...
	 */
	/*
	 * public CompteBancaire(String type, double solde, double decouvert, double
	 * tauxRemuneration) { super(); this.type = type; this.solde = solde;
	 * this.decouvert = decouvert; this.tauxRemuneration = tauxRemuneration; }
	 */
